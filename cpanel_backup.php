...
$cpuser = "ironxpxj"; // Username used to login to CPanel
$cppass = "euuxItgSpa7Y"; // Password used to login to CPanel
$domain = "irontin.com"; // Domain name where CPanel is run
$skin = "x3"; // Set to cPanel skin you use (script won't work if it doesn't match)

// Info required for FTP host
$ftpuser = "bc@regrowup.com"; // Username for FTP account
$ftppass = "!@#123qweasdzxc"; // Password for FTP account
$ftphost = "ftp.regrowup.com"; // Full hostname or IP address for FTP host
...
$notifyemail = "inc.academy.share@gmail.com"; // Email address to send results
