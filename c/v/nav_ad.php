    ...
    <body>
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:240px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block">
                ...
                <a href="/v/home.php" class="w3-bar-item w3-button w3-padding">HOME</a>
                <a href="/v/inventory.php" class="w3-bar-item w3-button w3-padding">Users</a>
                 <a href="/v/expiry.php" class="w3-bar-item w3-button w3-padding">Messages</a>
                 <hr>
